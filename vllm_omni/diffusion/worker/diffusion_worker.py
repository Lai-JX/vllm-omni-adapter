...
class DiffusionWorker:
    ...
    def init_device(self) -> None:
        ...
        with (
            ...
            logger.info(f"Worker {self.rank}: Initializing device and distributed environment. Port: {self.od_config.master_port}, ENV VARS: { {k: os.environ[k] for k in ['MASTER_ADDR', 'MASTER_PORT', 'LOCAL_RANK', 'RANK', 'WORLD_SIZE']} }")
